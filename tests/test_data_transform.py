...
def sample_df(spark):
    ...
    data = [
        ("Python Tutorial",   45000, "CodeMastery",  120000, 2300, 42.5, "Education"),
        ("Data Analysis",     38000, "DataLab",       98000, 1900, 38.0, "Data Science"),
        ("AWS Basics",        52000, "CloudTech",    145000, 2800, 45.0, "Cloud Computing"),
        ("Machine Learning",  61000, "AIExperts",    189000, 3500, 52.0, "AI/ML"),
        ("Database Design",   47000, "DataEng",      112000, 2100, 40.0, "Database"),
    ]
