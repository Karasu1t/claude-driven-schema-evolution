...
def sample_df(spark):
    ...
    data = [
        ...
        ("Data Analysis",     38000, "DataLab",       98000, 1900, 38.0, "Education"),
        ("AWS Basics",        52000, "CloudTech",    145000, 2800, 45.0, "Technology"),
        ("Machine Learning",  61000, "AIExperts",    189000, 3500, 52.0, "Technology"),
        ("Database Design",   47000, "DataEng",      112000, 2100, 40.0, "Technology"),
    ]
